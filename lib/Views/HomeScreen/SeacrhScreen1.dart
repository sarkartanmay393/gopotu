            ...
            Positioned(
              ...
              child: Obx(
                  ...
                  child: Center(
                    ...
                    : Padding(
                  padding: EdgeInsets.symmetric(horizontal: ScreenConstant.sizeSmall),
                          ...
                          onTap: () {
                            ...
                            Get.toNamed(storeDetails,
                                arguments: JsonEncoder().convert({
                                  "id": _searchController.storeList[index]
                                  ['id']
                                      .toString(),
                                  "isFavourite": true
                                }));
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (inputValue) {
                          if (lastInputValue != inputValue) {
                            ...
                            _searchController.searchListPress(false);
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsets.only(bottom: 10,left: ScreenConstant.defaultHeightFifteen), // Adjust the bottom padding to change the height
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          //           color: _searchController.storeSelect.value
                          //               ? AppColors.accentColor
                          //               : AppColors.secondary,
                          //         ),
                          //         child: Padding(
                          ...
                          Obx(() => GestureDetector(
                            onTap: () {
                              _searchController.itemSelect.value = true;
                              _searchController.storeSelect.value = false;
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(40),
                                border: Border.all(
                                    color: _searchController
                                        ...
                                        : AppColors
                                        .addressListWidgetBorderColor),
                                color: _searchController.itemSelect.value
                                    ? Colors.green
                                    : AppColors.secondary,
                              ),
                              child: Padding(
