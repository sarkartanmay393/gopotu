...
import '../../Widgets/HomeScreenWidgets/newProductsHomeScreenWidget.dart';
import '../../Widgets/ProductsHomeScreenWidget/ProductHomeScreenWidget.dart';

class ViewAllNewProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text(
            AppStrings.AllProductOffer,
            style: TextStyles.appBarTitle,
          ),
        ),
        body: _dashboardController.newProducts.length < 1
            ? Container(
                child: Center(
                    child: NoResult(
              ...
              child: Column(
                  children: [
                    ...
                    StaggeredGridView.countBuilder(
                      ...
                      itemCount: _dashboardController.newProducts.length,
                      itemBuilder: (context, index) {
                        return  Padding(
                          padding:  EdgeInsets.all(ScreenConstant.sizeMedium),
                          child: newProductsHomeScreenWidget(
                            index: index,
                            productList:
