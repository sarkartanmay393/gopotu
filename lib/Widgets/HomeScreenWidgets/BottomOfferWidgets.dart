...
class BottomOfferWidgets extends StatefulWidget {
  final List<dynamic> bannerList;

  BottomOfferWidgets({required this.bannerList});

  @override
  State<BottomOfferWidgets> createState() => _BottomOfferWidgetsState();
}

class _BottomOfferWidgetsState extends State<BottomOfferWidgets> {
  @override
    ...
    return Swiper(
      ...
      pagination: SwiperPagination(
          builder: DotSwiperPaginationBuilder(
            color: Colors.grey, // Set the color initially
